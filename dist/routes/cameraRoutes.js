...
cameraRoutes.get("/cameras", asyncHandler(async (_req, res) => {
    res.json({
        cameras: await faceDetectionService.listCameras(),
    });
}));
cameraRoutes.get("/cameras/:cameraId", asyncHandler(async (req, res) => {
...
cameraRoutes.post("/cameras", asyncHandler(async (req, res) => {
